...
import type { IntegrationUserConfig } from 'astro-pure/types'

type TypographyOptions = NonNullable<IntegrationUserConfig['typography']>
...
export function createTypographyConfig(typographyCustom: Partial<TypographyOptions> = {}) {
  return {
    cssExtend: {
      // Title
      'h2,h3,h4,h5,h6': {
...
export const utilityRules: Rule<object>[] = [
  [
    'sr-only',
    {
      position: 'absolute',
